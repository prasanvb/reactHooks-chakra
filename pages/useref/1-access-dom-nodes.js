...
const AccessDOMNodesWithUseRef = () => {
  ...
  return (
    <Container m={5} p={5}>
      <Text fontSize={20} textDecoration="underline">Imperatively Access DOM Nodes With useRef Hook</Text>
      <Text fontSize={15}>useRef is like a “box” that can hold a mutable value in its .current property.</Text>
      <Input id="firstname" ref={firstnameInputRef} name="firstname" placeholder="Enter you First Name"></Input>
      <Input id="lastname" name="lastname" placeholder="Enter you Last Name"></Input>
      <Input id="email" ref={emailInputRef} name="email" placeholder="Enter you Email"></Input>
